...
Therefore, H2 appears to be the better model. H2 has lower Out of sample error under both methods of calculation, both estimating out of sample error directly and estimating through variance + $bias^2$. This is as expected, due to the wave like nature of the underlying DGP. 
...
points(X$X2~X$X1, col = max.col(Y), pch = 16)
legend("bottomright", legend = c("alpha", "beta", "rho"), col = c("cyan", "orange", "magenta"), lty = 1, bg = "white")
