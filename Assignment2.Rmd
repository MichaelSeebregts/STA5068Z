...
obj = play_a_game
GA  = ga(type = 'real-valued',fitness = play_a_game,lower = rep(-10,npars),upper = rep(10,npars), popSize = 100,maxiter = 200,keepBest = TRUE, monitor = TRUE)
plot(GA)
...
Can see that there are quite large differences between the true value and the estimated value. X wins are overestimated by 26%, O wins are underestimated by 20% and draws are underestimated by 16%. Considering these are pointe estimates, there is large amounts of volatility and so would make sense. 
